...
// SELECTING THE div with class "section-center"
...
const displayMenuButtons = ()=>{
  ...
  const newBtn = categoryBtns.join("");
...
filterBtns.forEach((btn)=>{
  btn.addEventListener("click",(e)=>{
    ...
    const category = e.currentTarget.dataset.id;//dataset.id was used to get the value of each id of the button
...
let displayFoodMenu = foodMenu.map((item)=>{
